                ...
                Row(
                  children: <Widget> [
                    Expanded(
                      child: Align(
                        ...
                        child: Container(
                            ...
                            child: const Text(
                              'お気に入りチーム',
                              style: TextStyle(fontSize: StyleConstants.fontSizeNormal),
                            )
                        ),
                      ),
                    ),
                    Align(
                      ...
                      child: Container(
                        decoration: const BoxDecoration(color: StyleConstants.appColor),
                        margin: const EdgeInsets.all(StyleConstants.sm),
                      ...
                      child: Column(
                        children: [
                          SizedBox(
                              width: cardWidth * 0.8,
                              height: 110,
                              child: Image.asset('assets/images/favorite_teams/San_Francisco_49ers_logo_mini.png')
                          ),
                          const Text(
                            'San Francisco',
                            style: TextStyle(
